...
{	
	...
	var _html_template = 
		  "<div class='demo' id='A{0}' style='overflow:hidden; z-index:{1}; font-size:9pt; width:{2}px; height:{3}px; left:{4}; top:{5};'>"
	...
	this.init = function(frameIndex, topZ, w, h, leftPos, topPos, chName, url)
	{
		...
		this.html = String.format(_html_template, _frameIndex, _topZ, _w, _h, _leftPos, _topPos, _chName, _url);
	};
	
	this.setTemplate = function(html_template)
	{
	...
	{
		_html = String.format(_html_template, _frameIndex, _topZ, _w, _h, _leftPos, _topPos, _chName, _url);
